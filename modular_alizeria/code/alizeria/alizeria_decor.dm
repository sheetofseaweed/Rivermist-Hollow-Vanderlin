...
/obj/structure/fluff/walldeco/alizeriapaintings/queen
	...
	desc = "A painting of a renegade empress. Many code fanatics curse her, and some see her as an object to emulate. The latter are usually not welcomed by society."
	name = "picture"
	icon_state = "picture_queen"

/obj/structure/fluff/walldeco/alizeriapaintings/monsters
	icon = 'modular_alizeria/icons/roguetown/alizeria/vladegeg_decor.dmi'
	desc = "A picture of the trinity of major demonic forces that existed before the creation of the empire."
	name = "picture"
	icon_state = "picture_monsters"

/obj/structure/fluff/walldeco/alizeriapaintings/muscet
	icon = 'modular_alizeria/icons/roguetown/alizeria/vladegeg_decor.dmi'
	desc = "Painting of the famous musketeer who rose to become the personal guard of Regent Montfort."
	name = "picture"
	icon_state = "picture_muscet"

/obj/structure/fluff/walldeco/alizeriapaintings/crown
	icon = 'modular_alizeria/icons/roguetown/alizeria/vladegeg_decor.dmi'
	desc = "Picture of the crown that barons once upon a time allowed themselves to wear."
	name = "picture"
	icon_state = "picture_crown"

/obj/structure/fluff/walldeco/alizeriapaintings/sybaris
	icon = 'modular_alizeria/icons/roguetown/alizeria/vladegeg_decor.dmi'
	desc = "A picture of a forgotten city. Once upon a time, some tragedy happened there. However, no one cared about it, but the city was beautiful."
	name = "picture"
	icon_state = "picture_sybaris"

/obj/structure/fluff/walldeco/alizeriapaintings/demon
	icon = 'modular_alizeria/icons/roguetown/alizeria/vladegeg_decor.dmi'
	desc = "Disturbing picture. It is not known exactly who is depicted in it."
	name = "picture"
	icon_state = "picture_demon"

/obj/structure/fluff/walldeco/alizeriapaintings/strange
	icon = 'modular_alizeria/icons/roguetown/alizeria/vladegeg_decor.dmi'
	desc = "A strange picture of a city at night. Painted by a madman."
	name = "picture"
...
/obj/structure/fluff/walldeco/alizeria/decor/flag1
	name = "town flag"
	desc = "A simple flag of the town"
	icon = 'modular_alizeria/icons/roguetown/alizeria/vladegeg_decor.dmi'
	icon_state = "flag1"
...
/obj/structure/fluff/walldeco/alizeria/decor/flag4
	name = "gendarmerie flag"
	desc = "The usual banner of the gendarmerie."
	icon = 'modular_alizeria/icons/roguetown/alizeria/vladegeg_decor.dmi'
	icon_state = "flag4"
...
/obj/structure/fluff/walldeco/alizeria/decor/flag13
	name = "flag of an unknown kingdom"
	desc = "The usual banner of some hostile kingdom. His warriors are real psychos, you should be extremely careful."
	icon = 'modular_alizeria/icons/roguetown/alizeria/vladegeg_decor.dmi'
	icon_state = "flag13"

/obj/structure/fluff/walldeco/alizeria/decor/flagorkind1
	name = "orc's flag"
	desc = "Flag of the vile Orcs. Be careful, they're out there somewhere."
	icon = 'modular_alizeria/icons/roguetown/alizeria/vladegeg_decor.dmi'
...
/obj/structure/fluff/walldeco/alizeria/decor/sign3
	...
	icon = 'modular_alizeria/icons/roguetown/alizeria/decor64x32.dmi'
	icon_state = "sign3"
...
/obj/structure/flora/alizeria/decor/leavesr
	name = "leaves"
...
/obj/structure/roguecratesal
	name = "ящики"
	desc = ""
	icon = 'modular_alizeria/icons/roguetown/alizeria/yashiki.dmi'
	icon_state = "yashik"
	var/base_state
	density = TRUE
	opacity = FALSE
...
/obj/structure/fluff/walldeco/alizeria/decor/plakat1
	name = "wall newspaper"
	desc = "A bunch of newspapers collected on one wall. They are full of useless and irrelevant information."
	icon = 'modular_alizeria/icons/roguetown/alizeria/vladegeg_decor.dmi'
	icon_state = "plakat1"
