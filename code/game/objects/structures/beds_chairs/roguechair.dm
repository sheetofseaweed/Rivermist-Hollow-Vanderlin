...
/obj/structure/chair/wood/alt/uncomfortable
	...
	desc = "This has to be the most uncomfortable chair in Faerun. It looks like it will *violate* your backside." //This is a DE reference don't be fucking weird about it. // RMH
