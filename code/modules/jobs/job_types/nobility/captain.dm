...
/datum/job/captain/after_spawn(mob/living/carbon/human/spawned, client/player_client)
	...
	var/static/list/selectableweapon = list(
		"Law and Order" = list(/obj/item/weapon/sword/sabre/dec, /obj/item/weapon/shield/tower/buckleriron),
		"Deliverer of Justice" = /obj/item/weapon/polearm/halberd/bardiche,
	)
