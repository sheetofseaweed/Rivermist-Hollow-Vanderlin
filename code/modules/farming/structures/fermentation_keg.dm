...
/obj/structure/fermentation_keg/whitewine
	desc = "A barrel that contains a Darkholdian luxury. A sweeter tasting wine that often serves to highlight and enhance savoury notes. The rarer the vintage, the harder the find. The names of the ingredients often grow more ostentatious the closer you get to the capital."
...
/obj/structure/fermentation_keg/redwine
	desc = "A barrel that contains a Darkholdian luxury. It was originally served as part of Psydonic communion, eventually becoming wildly enjoyed within Darkhold to the point of being oft paired with EVERY meal."
