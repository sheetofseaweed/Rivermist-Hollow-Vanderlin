/datum/erp_action/other/anus/sex
	...
	message_start = "{actor} {pose} прижимается анусом к члену {partner}, раздвигая ягодицы."
	message_tick = "{actor} {pose}, {force} и {speed} скачет {aggr?задницей:ягодицами} на члене {partner}."
