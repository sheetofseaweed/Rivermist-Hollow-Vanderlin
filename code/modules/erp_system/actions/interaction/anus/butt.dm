/datum/erp_action/other/anus/butt
	...
	message_start = "{actor} {pose} прижимается попкой к члену {partner}."
	message_tick = "{actor} {pose}, {force} и {speed} водит {aggr?задницей:ягодицами} {dullahan?отделенной головы :}{partner}."
