/datum/erp_action/other/anus/tail
	...
	message_start = "{actor} {pose}  хватает хвост {partner} и направляет к своей попке."
	message_tick = "{actor} {pose}, {force} и {speed} удерживая хвост {partner} в своем анусе скачет на нём.."
