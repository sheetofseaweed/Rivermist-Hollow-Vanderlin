/datum/erp_action/other/tail/vaginal
	...
	message_start = "{actor} {pose} вводит хвостом в вагину {partner}."
	message_tick = "{actor} {pose}, {force} и {speed} {aggr?сношает хвостом киску:играется хвостом в киске} {dullahan?отделенной головы :}{partner}."
