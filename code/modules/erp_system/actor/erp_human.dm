...
/datum/erp_actor/human/has_big_breasts()
	...
	var/obj/item/organ/genitals/filling_organ/breasts/B = H.getorganslot(ORGAN_SLOT_BREASTS)
	if(!B || !isnum(B.organ_size))
		return FALSE

	return B.organ_size >= BREAST_SIZE_LARGE
