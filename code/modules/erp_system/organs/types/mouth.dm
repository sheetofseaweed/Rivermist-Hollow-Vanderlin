...
/datum/erp_sex_organ/mouth/receive_reagents(datum/reagents/R, amount)
	...
	var/milk_amt = storage.reagents.get_reagent_amount(/datum/reagent/consumable/milk)
	if(milk_amt > 0)
		storage.reagents.remove_reagent(/datum/reagent/consumable/milk, milk_amt)
		H.reagents.add_reagent(/datum/reagent/consumable/milk, milk_amt)
