...
GLOBAL_LIST_INIT(traits_by_type, list(
	...
	/mob = list(
		...
		"Blessing of Blissara" = TRAIT_CRACKHEAD,
		"Blessing of Gruumsh" = TRAIT_ORGAN_EATER,
		"Rot Eater"= TRAIT_ROT_EATER,
		"Blessing of Silvanus" = TRAIT_KNEESTINGER_IMMUNITY,
		"Blessing of Jergal" = TRAIT_SOUL_EXAMINE,
		...
		"Nudist" = TRAIT_NUDIST,
		"Inhuman Anatomy" = TRAIT_INHUMANE_ANATOMY,
		"Inhuman Digestion" = TRAIT_NASTY_EATER,
...
GLOBAL_LIST_INIT(roguetraits, list(
	...
	TRAIT_INHUMANE_ANATOMY = "My anatomy is inhuman, preventing me from wearing hats and shoes.",
	...
	TRAIT_ASSASSIN = "My soul has been tainted by Gruumsh, and bloodshed comes easy to me.",
	TRAIT_BARDIC_TRAINING = "Tymoran inspiration grants my songs boons and ailments.",
	TRAIT_GRAVEROBBER = "Jergal seems to ignore my grim deeds, I can unearth graves without being cursed by him.",
	TRAIT_GOODLOVER = span_love("It's a lucky thing to share my bed."),
	TRAIT_EGG_LAYER = span_love("My fertile womb slowly forms eggs on its own."),
	...
	TRAIT_MALUMFIRE = "My hands are blessed by Moradin to forge items of superb quality.",
	...
	TRAIT_DREAM_WATCHER = span_notice("I'm blessed by Mystra, my dreams tell more than the average person.."),
	...
	TRAIT_TRUE_GRIT = span_info("I can shrug off my wounds and maintain composure under duress. My own mortality is proof that I LIVE, and so does HE."),
	...
	TRAIT_LUCKY_COOK = span_info("Tymora smiles upon my cooking, I often end up with impossible amounts of extra goods..."),
