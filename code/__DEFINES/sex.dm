...
#define HORNY_MOB_TYPE_ALL (HORNY_MOB_TYPE_HUMANOIDS | HORNY_MOB_TYPE_SPIDERS | HORNY_MOB_TYPE_BOG_BUGS | HORNY_MOB_TYPE_TROLLS | HORNY_MOB_TYPE_BEASTS | HORNY_MOB_TYPE_LAMIAS | HORNY_MOB_TYPE_MINOTAURS | HORNY_MOB_TYPE_LYCANS | HORNY_MOB_TYPE_LIZARDS | HORNY_MOB_TYPE_UNDEAD | HORNY_MOB_TYPE_TENTACLES)
