...
#define ADMIN_NRT(user) "(<a href='byond://?_src_=holder;[HrefToken(TRUE)];narrateto=[REF(user)]'>NRT</a>)"
...
#define ADMIN_BIRD_LETTER(user) "(<a href='byond://?_src_=holder;[HrefToken(TRUE)];adminbirdletter=[REF(user)]'>LETTER</a>)"
