...
/datum/component/trader/proc/buy_item(mob/customer)
	...
	var/list/quality_result = trader_data.active_faction?.get_faction_quality_calculator(item_to_buy)
	if(quality_result)
		create_quality_item(item_to_buy, quality_result[1], quality_override = quality_result[2])
