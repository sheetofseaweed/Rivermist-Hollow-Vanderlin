/datum/ai_controller/minotaur
	...
	blackboard = list(
		...
		BB_MINOTAUR_BERSERK = FALSE,
		BB_MINOTAUR_COMBAT_PLAN = null,
		BB_MINOTAUR_PLAN_ZONE = null,
		BB_MINOTAUR_PLAN_TARGET = null,
		BB_MINOTAUR_WOUNDS_INFLICTED = 0,
		BB_MINOTAUR_DEFENSE_COOLDOWN = 0,
	)
