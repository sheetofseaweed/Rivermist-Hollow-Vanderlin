/datum/attribute_holder/sheet/job/cook
	raw_attribute_list = list(
		...
		/datum/attribute/skill/craft/cooking/preparation = 45,
		/datum/attribute/skill/craft/cooking/baking = 40,
		/datum/attribute/skill/craft/cooking/grilling = 40,
		/datum/attribute/skill/craft/cooking/fine_cuisine = 35,
		/datum/attribute/skill/craft/cooking/preservation = 35,
