/datum/action/cooldown/spell/undirected/shapeshift/wolf
	name = "Wolf Form"
	desc = "Transform into a wolf. Damage is not inherited between forms!"
	...
	possible_shapes = list(/mob/living/simple_animal/hostile/retaliate/wolf)
	die_with_shapeshifted_form = FALSE
	convert_damage = FALSE

/datum/action/cooldown/spell/undirected/shapeshift/wolf/do_shapeshift(mob/living/caster)
	. = ..()
	if(!.)
		return
