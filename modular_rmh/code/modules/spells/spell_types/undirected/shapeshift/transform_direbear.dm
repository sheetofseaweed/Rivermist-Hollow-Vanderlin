/datum/action/cooldown/spell/undirected/shapeshift/direbear
	name = "Direbear Form"
	desc = "Transform into a direbear. Damage is not inherited between forms."
	...
	possible_shapes = list(/mob/living/simple_animal/hostile/retaliate/direbear)
	die_with_shapeshifted_form = FALSE
	convert_damage = FALSE

/datum/action/cooldown/spell/undirected/shapeshift/direbear/do_shapeshift(mob/living/caster)
	. = ..()
	if(!.)
		return
