/datum/action/cooldown/spell/undirected/shapeshift/spider
	name = "Spider Form"
	desc = "Transform into a spider. Damage is not inherited between forms!"
	...
	possible_shapes = list(/mob/living/simple_animal/hostile/retaliate/spider)
	die_with_shapeshifted_form = FALSE
	convert_damage = FALSE

/datum/action/cooldown/spell/undirected/shapeshift/spider/do_shapeshift(mob/living/caster)
	. = ..()
	if(!.)
		return
