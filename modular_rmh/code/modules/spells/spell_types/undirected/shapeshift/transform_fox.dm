/datum/action/cooldown/spell/undirected/shapeshift/fox
	name = "Fox Form"
	desc = "Transform into a fox. Damage is not inherited between forms."
	...
	possible_shapes = list(/mob/living/simple_animal/hostile/retaliate/fox)
	die_with_shapeshifted_form = FALSE
	convert_damage = FALSE

/datum/action/cooldown/spell/undirected/shapeshift/fox/do_shapeshift(mob/living/caster)
	. = ..()
	if(!.)
		return
