/mob/living/simple_animal/hostile/retaliate/direbear	//This way don't need new unqiue AI controller. Wolves are modular anyway.
	icon = 'modular_rmh/icons/mob/monster/direbear.dmi'
	name = "direbear"
	icon_state = "direbear"
	...
	attack_sound = list('modular_rmh/sound/mob/abyssal/direbear/direbear_attack1.ogg','modular_rmh/sound/mob/abyssal/direbear/direbear_attack2.ogg','modular_rmh/sound/mob/abyssal/direbear/direbear_attack3.ogg')
	dodgetime = 30
	aggressive = 1
...
/mob/living/simple_animal/hostile/retaliate/direbear/get_sound(input)
	switch(input)
		if("aggro")
			return pick('modular_rmh/sound/mob/abyssal/direbear/direbear_attack1.ogg')	//Placeholder till we get more sounds
		if("pain")
			return pick('modular_rmh/sound/mob/abyssal/direbear/direbear_death1.ogg')	//Placeholder till we get more sounds
		if("death")
			return pick('modular_rmh/sound/mob/abyssal/direbear/direbear_death1.ogg', 'modular_rmh/sound/mob/abyssal/direbear/direbear_death2.ogg')
...
/datum/intent/simple/bite/bear
	clickcd = CLICK_CD_MELEE	//Slightly slower than wolfs by .1
