...
/mob/living/simple_animal/hostile/retaliate/fox
	icon = 'modular_rmh/icons/mob/monster/fox.dmi'
	name = "venard"
	...
	see_in_dark = 6
	move_to_delay = 3
	base_intents = list(/datum/intent/simple/bite)	//Same as volf, simplicity is key
	aggressive = 1
	botched_butcher_results = list(/obj/item/reagent_containers/food/snacks/meat/steak = 1, /obj/item/alch/viscera = 1, /obj/item/alch/bone = 3)
...
/mob/living/simple_animal/hostile/retaliate/fox/taunted(mob/user)
	emote("aggro")
	return
