...
#define CHESS_SOUND_NOTIFY 'modular_rmh/sound/chess/notify.ogg'
#define CHESS_SOUND_MOVE 'modular_rmh/sound/chess/chess_move.ogg'
#define CHESS_SOUND_CAPTURE 'modular_rmh/sound/chess/capture.ogg'
#define CHESS_SOUND_CHECKERS_MOVE 'modular_rmh/sound/chess/move-shashka.ogg'
#define CHESS_SOUND_RAGE 'modular_rmh/sound/chess/rage_chess.ogg'
#define CHESS_SOUND_RESET 'modular_rmh/sound/chess/sbor_chess.ogg'
#define CHESS_SOUND_PICKUP 'modular_rmh/sound/chess/pick_up_chess.ogg'
#define CHESS_SOUND_WIN 'modular_rmh/sound/chess/win.ogg'
#define CHESS_SOUND_LOSS 'modular_rmh/sound/chess/loss.ogg'
#define CHESS_SOUND_CHECK 'modular_rmh/sound/chess/schah_chess.ogg'
#define CHESS_SOUND_DICE1 'modular_rmh/sound/chess/dice1.ogg'
#define CHESS_SOUND_DICE2 'modular_rmh/sound/chess/dice2.ogg'
#define CHESS_SOUND_DICE3 'modular_rmh/sound/chess/dice3.ogg'
...
/obj/item/chessboard_folded
	...
	icon = 'modular_rmh/icons/chess/chess.dmi'
	icon_state = "chessboard_folded"

/obj/item/chessboard_folded/attack_self(mob/user, list/modifiers)
	if(!user)
		return
...
/obj/structure/chessboard/attack_hand(mob/user, list/modifiers)
	if(!user)
		return ..()
	ui_interact(user)
	return TRUE

/obj/structure/chessboard/AltClick(mob/user, list/modifiers)
	return ..()

/obj/structure/chessboard/attack_hand_secondary(mob/user, list/modifiers)
	. = ..()
